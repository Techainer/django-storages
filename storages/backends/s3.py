...
from storages.backends.s3refreshablesession import InstanceMetadataBotoSession
...
class S3Storage(CompressStorageMixin, BaseStorage):
    ...
    is_refreshable_session = setting("AWS_S3_REFRESHABLE_SESSION", False)
